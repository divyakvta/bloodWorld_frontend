    ...
    const handleUpdateStatus = async (toggle: boolean, checkLastDonation: boolean) => {
        try {
            ...
            setUserData((prevData) =>
                prevData ? { ...prevData, isActive: response.data.isActive } : null
            );
        ...
        <div className='container mx-auto min-h-screen p-8 my-8 flex flex-col justify-center items-center bg-gray-100'>
            ...
            <div className='container w-1/2 mx-auto my-10 p-8 bg-white shadow-lg rounded-xl'>
                <div className='flex items-center gap-6'>
                    <div className='h-24 w-24 bg-gray-300 rounded-full flex items-center justify-center relative'>
                    ...
                    <div className='ml-auto flex flex-col space-y-4'>
                        ...
                        {userData?.isActive ? (
                            ...
                            <button
                                ...
                                className='w-60 py-2 px-4 bg-gradient-to-r from-red-700 via-red-600 to-red-500 text-white rounded-md shadow hover:bg-green-600'
                            >
                                Activate Account
                            </button>
                        )}
